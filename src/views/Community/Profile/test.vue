...
<v-container grid-list-xs>
    ...
    <v-row align="center" justify="center">
        <v-col align="center" justify="center" cols="4"><v-row >picบน</v-row>
        <v-row>picล่าง</v-row></v-col>
        <v-col align="center" justify="center" cols="4"><v-row>picบน</v-row>
        <v-row>picล่าง</v-row></v-col>
        <v-col align="center" justify="center" cols="4"><v-row>picบน</v-row>
        <v-row>picล่าง</v-row></v-col>
        <v-col align="center" justify="center" cols="6"><v-row>picบน</v-row>
        <v-row>picล่าง</v-row></v-col>
        <v-col align="center" justify="center" cols="6"><v-row>picบน</v-row>
        <v-row>picล่าง</v-row></v-col>

         <v-col align="center" justify="center" cols="12"><v-col>55</v-col>66</v-col>
